...
public interface CommentDAO {
     ...
     * list size to the dimension specified, starting from the comment specified as argument, in reverse order. It
     * allows the
     ...
     */
    List<Comment> commentsByPostIdPrev(String postId, Comment offset, Integer pageSize) throws SocialNewsDataAccessException;
     ...
     * @throws SocialNewsDataAccessException in case of failure of the query operation on database
     */
    List<Comment> commentsByPostIdNext(String postId, Comment offset, Integer pageSize) throws SocialNewsDataAccessException;
